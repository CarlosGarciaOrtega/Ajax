...
(() => {
    ...
    showPaisModal.addEventListener('hidden.bs.modal', function (event) {
        editCode.value = '';
        editUrl.value = '';
        editName.value = '';
    })
    ...
    function peticionEditPais() {
        ...
        .then(data => {
            ...
            if(data.result > 0) {
                ...
                modalInstance.hide();
                solucionAriel(data, false);
                document.getElementById("okAlert").innerHTML=""
                document.getElementById("okAlert").innerHTML="Pais editado correctamente"
    ...
    function peticionDeletePais() {
        ...
        fetch(deleteUrl.value+'pais/'+editCode.value, {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json',
        ...
        .then(data => {
            ...
            if(data.result > 0) {
                ...
                solucionAriel(data, false);
                document.getElementById("okAlert").innerHTML=""
                document.getElementById("okAlert").innerHTML="Pais eliminado correctamente"
            }
        })
        .catch(error => console.error("Error:", error));
    };
    ...
    function solucionAriel(data, condicion) {
        ...
        for(const pais of data.paises) {
            ...
            showBtn.onclick =()=>{
                ...
                document.getElementById("codeShow").innerHTML=pais.code;
                document.getElementById("nameShow").innerHTML=pais.name;
            }
