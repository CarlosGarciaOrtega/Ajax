...
<div class="modal" id="deletePaisModal" tabindex="-1"> 
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      Seguro que quieres eliminar el pais
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="btnDeletePais" class="btn btn-primary">Delete</button>
      </div>
    </div>
  </div>
</div>
<div class="modal" id="showPaisModal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Ver país</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        Pais  <span id="nameShow"></span> con  codigo
